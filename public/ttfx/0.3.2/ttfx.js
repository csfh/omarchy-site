...
export class Session {
     ...
     */
        ...
        const ret = wasm.session_done(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     * @param {Uint32Array} fg
     * @param {Uint32Array} bg
     * @param {Uint8Array} flags
     */
    fill(symbols, fg, bg, flags) {
        const ret = wasm.session_fill(this.__wbg_ptr, symbols, fg, bg, flags);
        if (ret[1]) {
 ...
 * @returns {string}
 */
export function effect_catalog() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.effect_catalog();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_getRandomValues_fdfdbc55707b6036: function(arg0) {
            crypto.getRandomValues(arg0);
        },
        ...
        __wbg_set_e575799cdfbae72f: function(arg0, arg1, arg2) {
        ...
        __wbg_subarray_e3ceefdfcd5100ac: function(arg0, arg1, arg2) {
            const ret = arg0.subarray(arg1 >>> 0, arg2 >>> 0);
            return ret;
        },
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        throw new TypeError("init() requires a wasm URL or bytes");
    }
    const imports = __wbg_get_imports();
